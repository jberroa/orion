...
export const initialServices: Service[] =[
  createService({
    name: 'DS 3.0',
    folder: 'core-services/projects/services/src-services/data-services',
    tokenName: 'DataService30',
    webPath: 'data-services-3.0',
    warPath: 'core-services/projects/services/target/bullhorn-data-services-3.0',
    javaVersion: 8,
  ...
  createService({
    name: 'DS 4.0',
    folder: 'core-services/projects-jdk17/data-services',
    tokenName: 'DataService40',
    webPath: 'data-services-4.0',
    warPath: 'core-services/projects-jdk17/data-services/target/data-services-4.0',
    javaVersion: 17,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'core-services/projects/services/src-services/data-event-services',
    tokenName: 'DataEventService',
    webPath: 'data-event-services',
    warPath: 'core-services/projects/services/target/bullhorn-data-event-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'core-services/projects/services/src-services/daytona-consumer',
    tokenName: 'daytonaConsumerV2',
    webPath: 'daytona-consumer',
    warPath: 'core-services/projects/services/target/bullhorn-daytona-consumer-2.0',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'core-services/projects/services/src-services/daytona-producer',
    tokenName: 'daytonaIndexV2',
    webPath: 'indexing',
    warPath: 'core-services/projects/services/target/bullhorn-daytona-producer-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'core-services/projects/services/src-services/daytona-search',
    tokenName: 'daytonaSearchV2',
    webPath: 'search',
    warPath: 'core-services/projects/services/target/bullhorn-daytona-search-2.0',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    name: 'Email Services',
    folder: 'core-services/projects/services/src-services/email-services',
    tokenName: 'EmailService',
    webPath: 'email-services',
    warPath: 'core-services/projects/services/target/bullhorn-email-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'core-services/projects/services/src-services/franklin-services',
    tokenName: 'FranklinService',
    webPath: 'appointment-services',
    warPath: 'core-services/projects/services/target/bullhorn-franklin-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    name: 'OAuth Services',
    folder: 'core-services/projects/services/src-services/oauth-services',
    tokenName: 'OAuthService',
    webPath: 'oauth',
    warPath: 'core-services/projects/services/target/bullhorn-oauth-services-2.0',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    name: 'Rest Services',
    folder: 'core-services/projects-jdk17/rest-services',
    tokenName: 'RestService',
    webPath: 'rest-services',
    warPath: 'core-services/projects-jdk17/rest-services/target/rest-services-4.0',
    javaVersion: 17,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/core-services.git',
    parentRepo: 'Core Services',
    tomcatNumber: 2,
  ...
  createService({
    ...
    folder: 'bifrost/undefined',
    tokenName: 'Bifrost_bullhorn-to-linkedin-bootstrap',
    webPath: 'bullhorn-to-linkedin-bootstrap',
    warPath: 'bifrost/bullhorn-to-linkedin-bootstrap/target/bullhorn-to-linkedin-bootstrap',
    javaVersion: 8,
  ...
  createService({
    ...
    warPath: 'bifrost/bullhorn-to-linkedin-decommission/target/bullhorn-to-linkedin-decommission',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/bullhorn-to-linkedin-live-sync/target/bullhorn-to-linkedin-live-sync',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/kafka-integration-test-consumer/target/kafka-integration-test-consumer',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/linkedin-callback-controller/target/linkedin-callback-controller',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/linkedin-inmail-and-note-consumer/target/linkedin-inmail-and-note-consumer',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/linkedin-one-click-export/target/linkedin-one-click-export',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'bifrost/linkedin-poll-request-forwarder/target/linkedin-poll-request-forwarder',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/bifrost.git',
    parentRepo: 'Bifrost',
    tomcatNumber: 3,
  ...
  createService({
    ...
    warPath: 'billing-sync/billing-sync-consumer-services/target/billing-sync-consumer-services',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:MIDDLE_OFFICE/billing-sync.git',
    parentRepo: 'Billing Sync',
    tomcatNumber: 3,
  ...
  createService({
    name: 'CDC',
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/change-data-capture-services.git',
    folder: 'change-data-capture-services',
    tomcatNumber: 3,
    tokenName: 'CDC',
    webPath: 'change-data-capture-services',
    warPath: 'change-data-capture-services/change-data-capture-services/target/change-data-capture-services',
    javaVersion: 8
  }),
  createService({
    name: 'Daytona Consumer V1',
    folder: 'classic_ats/undefined',
    tokenName: 'daytonaConsumerV1',
    webPath: 'daytona-consumer',
    warPath: 'classic_ats/java/projects/services/src-services/daytona-consumer/target/bullhorn-daytona-consumer-0.1',
    javaVersion: 8,
  ...
  createService({
    ...
    webPath: 'search',
    warPath: 'classic_ats/java/projects/services/src-services/daytona-search/target/bullhorn-daytona-search-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:LEGACY_ATS/classic_ats.git',
    parentRepo: 'Classic ATS',
    tomcatNumber: 1,
  ...
  createService({
    ...
    warPath: 'dataservices-0_1/java/projects/services/src-services/data-services/target/bullhorn-data-services-0.1',
    javaVersion: 7
  }),
  createService({
    name: 'DS 2.0',
    ...
    warPath: 'dataservices-2_0/java/projects/services/src-services/data-services/target/bullhorn-data-services-2.0',
    javaVersion: 7
  }),
  createService({
    name: 'DS 2.5',
    ...
    warPath: 'dataservices-2-5/java/projects/services/src-services/data-services/target/bullhorn-data-services-2.5',
    javaVersion: 7
  }),
  createService({
    name: 'EMS',
    ...
    warPath: 'entity-model-streamer/entity-model-streamer-services/target/entity-model-streamer',
    javaVersion: 17
  }),
  createService({
    ...
    warPath: 'estaff-integrations/estaff-integrations-services/target/estaff-integrations-services',
    javaVersion: 8
  }),
  createService({
    name: 'ETL Services',
  ...
  createService({
    name: 'Gateway Proxy',
    gitUrl: 'git@bhsource.bullhorn.com:platform/java/services/gateway-proxy.git',
  ...
  createService({
    ...
    gitUrl: 'git@bhsource.bullhorn.com:internal_tooling/jira-gitlab-integrator.git',
  ...
  createService({
    name: 'SOAP 2.6',
    folder: 'legacy-core-services',
    tokenName: 'SoapService26',
    webPath: 'webservices-2.6',
    warPath: 'legacy-core-services/projects/services/target/bullhorn-api-services-2.6',
    javaVersion: 8,
  ...
  createService({
    ...
    warPath: 'legacy-core-services/projects/services/target/bullhorn-data-services-2.6',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:LEGACY_ATS/legacy-core-services.git',
    parentRepo: 'Legacy CS',
    tomcatNumber: 1,
  ...
  createService({
    ...
    warPath: 'legacy-core-services/projects/services/target/bullhorn-scheduler-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:LEGACY_ATS/legacy-core-services.git',
    parentRepo: 'Legacy CS',
    tomcatNumber: 1,
  ...
  createService({
    ...
    tokenName: 'helsinki',
    webPath: 'isync',
    warPath: 'legacy-core-services/projects/services/target/bullhorn-helsinki-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:LEGACY_ATS/legacy-core-services.git',
    parentRepo: 'Legacy CS',
    tomcatNumber: 1,
  ...
  createService({
    ...
    warPath: 'legacy-core-services/projects/services/target/bullhorn-pulse-services-0.1',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:LEGACY_ATS/legacy-core-services.git',
    parentRepo: 'Legacy CS',
    tomcatNumber: 1,
  ...
  createService({
    ...
    folder: 'mass-action-services/undefined',
    tokenName: 'MassActionConsumer',
    webPath: 'mass-action-consumer',
    warPath: 'mass-action-services/mass-action-consumer/target/mass-action-consumer',
    javaVersion: 8,
  ...
  createService({
    ...
    warPath: 'mass-action-services/mass-action-producer/target/mass-action-producer',
    javaVersion: 8,
    gitUrl: 'git@bhsource.bullhorn.com:ATS_CRM/mass-action-services.git',
    parentRepo: 'Mass Action Services',
    tomcatNumber: 3,
  ...
  createService({
    name: 'Payable Export',
    gitUrl: 'git@bhsource.bullhorn.com:MIDDLE_OFFICE/payable-export-services.git',
    folder: 'payable-export-services',
    tomcatNumber: 3,
    tokenName: 'PayableExportService',
    webPath: 'payable-export-services',
    warPath: 'payable-export-services/payable-export-services/target/payable-export-services',
    javaVersion: 8
  }),
  createService({
    name: 'Rest API Tests',
  ...
  createService({
    ...
    warPath: 'seek-integration-services/seek-webhook-service/target/seek-webhook-service',
    javaVersion: 8
  }),
  createService({
    name: 'SMS Service',
  ...
  createService({
    ...
    warPath: 'apiservices-0_1/java/projects/services/src-services/api-services/target/bullhorn-api-services-0.1',
    javaVersion: 7
  }),
  createService({
    name: 'SOAP 1.1',
  ...
  createService({
    ...
    warPath: 'apiservices-2_0/java/projects/services/src-services/api-services/target/bullhorn-api-services-2.0',
    javaVersion: 7
  }),
  createService({
    name: 'SOAP 2.5',
    ...
    warPath: 'apiservices-2_5/java/projects/services/src-services/api-services/target/bullhorn-api-services-2.5',
    javaVersion: 7
  }),
  createService({
    name: 'SQL',
  ...
  createService({
    ...
    warPath: 'status-processor/status-processor-services/target/status-processor-services',
    javaVersion: 17
  }),
  createService({
  ...
  createService({
    ...
    gitUrl: 'git@bhsource.bullhorn.com:internal_tooling/translation-automation.git',
  ...
  createService({
    ...
    gitUrl: 'git@bhsource.bullhorn.com:DEV_WORKSPACE/translation-automation-mr.git',
